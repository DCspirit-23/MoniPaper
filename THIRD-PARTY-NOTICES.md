...
The Windows x64 self-contained v1.0.0, v1.0.1, v1.1.0, v1.2.0, v1.2.1, and v1.3.0 distributions include Microsoft .NET 10.0.8 components. Their copyright and license notices are retained separately and are not replaced by MoniPaper's license.
